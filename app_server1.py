...
#                "double derivative","lâ‚ ","lâ‚‚","first","second","third","fourth","first pulley","moving pulley","lâ‚ƒ","constraint equation","What are the final accelerations, tensions and normal reactions","final",
...
phrase_list = ["don't know how to start","how to start", "how start", "moving objects", "FBD", "nlm", "laws of motion", "red block", "yellow block", "blue block", "green block"
               , "purple block", "pink string", "red string", "white string", "yellow string", "How many moving objects", "many strings", "imaginary sphere",
               "each moving block", "strings", "string","force at this point of intersection","intersection","y-direction","FBD equation","how many points","cuts the strings"
               ,"moving pulley","rate of change","length of string","left","right","human","only","and","Net","number of parts which change length","change length","number of parts",
               ...
               "contacting surfaces", "surfaces", "contacting", "normal", "reaction", "block 1", "incline","perpendicular", "acceleration", "wedge", "x-direction", "first", "second", "third","final", "constraint", "big"
               ]
...
# # Provided sentence
# sentence = "What is double derivative of change in lâ‚  for red string due to yellowblock"
...
def predict_step():
    try:
        ...
        # Load JSON data from a file
        # path = "C:/Users/Shivam Saxena/Downloads/server/server/data/q68.json" 
        # #+str(question_num)+".json"
        ...
        if question_num == "68":
            ...
            # return 0, 0
                step = 0
                index = 0
            if ( binary_output[-9] == 1 and binary_output[7] == 1 ) or ( binary_output[-8] == 1 and binary_output[-2] == 1):
            # return 0, 0
                step = 1
                index = 0    
            # Create the response JSON
        ...
        #     # return 0, 0
        #         step = 3 #constraint step index is 2 cause understanding is removed
        #         index = 0  
        #     if binary_output[-3] == 1:
        #     # return 0, 0
        #         step = 4
