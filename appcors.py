    ...
    try:
        ...
        if question_num == "18":
            ...
            # return 0, 0
                step = 1
                index = 3
            if binary_output[9] == 1 and binary_output[4] == 1:#blue fbd
            # return 0, 0
                step = 1
                index = 6
            if binary_output[12] == 1 and binary_output[-2] == 1: #pink constraint
        ...
        if question_num == "68":
            ...
            # return 0, 0
                ...
                index = 0
            # Create the response JSON
            if binary_output[-2] == 1 and binary_output[-8] == 1:
            # return 0, 0
                step = 1
                index = 0
            if binary_output[-9] == 1 and binary_output[7] == 1:
            # return 0, 0
                step = 1
                index = 0
            # Create the response JSON
        ...
        if question_num == "11":
            ...
            # return 0, 0
                step = 1
                index = 3
            if binary_output[28] == 1 and binary_output[4] == 1:#second pulley fbd
            # return 0, 0
                step = 1
                index = 6
            if binary_output[12] == 1 and binary_output[-2] == 1:#pink constraint
